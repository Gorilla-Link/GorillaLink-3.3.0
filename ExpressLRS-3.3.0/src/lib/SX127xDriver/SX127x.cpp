...
void ICACHE_RAM_ATTR SX127xDriver::CommitOutputPower()
{
  ...
  {//20dbm
    ...
    //20dbm
    hal.writeRegister(SX127X_REG_PA_DAC, 0x87, SX12XX_Radio_All);  //turn on 3rd amplifier, see 5.4.3
  ...
  { //15dbm <<<
    pwrCurrent = pwrPending;
    pwrPending = PWRPENDING_NONE;
    hal.writeRegister(SX127X_REG_PA_DAC, 0x84, SX12XX_Radio_All); //turn off 3rd amplifier, see 5.4.3
    hal.writeRegister(SX127X_REG_PA_CONFIG, pwrCurrent, SX12XX_Radio_All);
  }
}
